...
class QuizInterface:
    def __init__(self,quiz:QuizBrain):
        ...
        right_button = Button(image=right_image,command=self.correct_button)
        right_button.grid(row=3,column=1)

        #-------------------- wrong Button --------------- #
        wrong_image = PhotoImage(
            file=r"D:\projects\Udemy\100-days-of-code-Python\Day_34\quizzler-app-start\images\false.png")
        wrong_button = Button(image=wrong_image,command=self.wrong_button)
